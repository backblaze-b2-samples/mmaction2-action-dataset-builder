...
const navItems = [
  ...
  { title: "Builds", href: "/builds", icon: Layers },
  { title: "Dataset", href: "/dataset", icon: Film },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-mmaction2-action-dataset-builder"
          target="_blank"
