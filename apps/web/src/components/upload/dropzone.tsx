...
const MAX_SIZE = 500 * 1024 * 1024; // 500MB — raw broadcast/security footage can be large
...
export function Dropzone({
  ...
  let title = "Drag & drop raw video here, or click to browse";
  let description = "Max file size: 500 MB per file";
