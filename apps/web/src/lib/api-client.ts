...
export async function getSources() {
  return apiFetch<SourceVideo[]>("/builds/sources");
}

export async function getBuilderStats() {
  return apiFetch<BuilderStatsSummary>("/builds/stats");
}

export async function getBuilds() {
  return apiFetch<BuildSummary[]>("/builds");
}
...
export async function getBuildDataset(id: string) {
  return apiFetch<ClassGroup[]>(`/builds/${id}/dataset`);
}
...
export async function runBuild(id: string) {
  return apiFetch<BuildJob>(`/builds/${id}/run`, { method: "POST" });
}

export async function getBuildJobs() {
  return apiFetch<BuildJob[]>("/builds/jobs/list");
}

export async function getClipPreviewUrl(buildId: string, clipId: string) {
  return apiFetch<{ url: string }>(`/builds/${buildId}/clips/${clipId}/preview`);
}
