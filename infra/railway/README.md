...
- **Build Command**: `pip install -r requirements.txt && pip install -r requirements-ml.txt`
  (the ML stack is required for the labeling step; omit it only if you run a
  segment/clip-only deployment)
...
| Variable | Value |
|----------|-------|
| `B2_REGION` | Your B2 region (e.g. `us-west-004`); the S3 endpoint is derived as `https://s3.<region>.backblazeb2.com` |
| `B2_APPLICATION_KEY_ID` | Your B2 key ID |
| `B2_APPLICATION_KEY` | Your B2 application key |
| `B2_BUCKET_NAME` | Your bucket name |
| `B2_PUBLIC_URL_BASE` | (optional) Public base URL for object links |
