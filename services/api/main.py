...
from app.runtime import builds, files, health, metrics, upload  # noqa: E402
...
app = FastAPI(
    title="MMAction2 Action Dataset Builder API",
    description="Build labeled action-recognition datasets from raw video, stored on Backblaze B2",
    version="0.1.0",
    lifespan=lifespan,
)
